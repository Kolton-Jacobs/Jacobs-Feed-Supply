# Jacobs Feed & Supply — Website Project (CMPA 3301)
...
## Documentation
Planning documents are located in the `/docs` folder:
- `docs/scope.md` — Project scope statement
- `docs/plan.md` — Project plan with risk analysis (TAME) and task schedule (WBS)
- `docs/retrospective.md` — Project retrospective reflection

## Repo Contents
- `index.html` — Homepage
- `about.html` — About page
- `style.css` — Shared stylesheet for both pages
- `docs/` — Planning and reflection documentation
